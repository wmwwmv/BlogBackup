...
(function($) {
  $.fn.flexNav = function(options) {
    ...
    $('.item-with-ul, .menu-button').append('<span class="drawer-button"><i class="icon-menu navicon"></i></span>');
    $('.menu-button .drawer-button').on('touchstart mousedown', function(e) {
      e.preventDefault();
      e.stopPropagation();
    ...
    $('.drawer-button').on('touchstart mousedown', function(e) {
      e.stopPropagation();
      e.preventDefault();
      return $(this).on('touchmove mousemove', function(e) {
        isDragging = true;
